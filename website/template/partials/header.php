<!DOCTYPE html>
    <html>
        <head>
            ...
            <!-- Font Awesome CSS-->
            <link rel="stylesheet" href="/website/assets/vendor/font-awesome/css/font-awesome.min.css">

            <!-- Custom Font Icons CSS-->
            <link rel="stylesheet" href="/website/assets/css/landy-iconfont.css">

            <!-- Google fonts - Open Sans-->
            <link rel="stylesheet" href="/website/assets/https://fonts.googleapis.com/css?family=Open+Sans:300,400,700,800">

            <!-- owl carousel-->
            <link rel="stylesheet" href="/website/assets/vendor/owl.carousel/assets/owl.carousel.css">
            <link rel="stylesheet" href="/website/assets/vendor/owl.carousel/assets/owl.theme.default.css">

            <!-- theme stylesheet-->
            <link rel="stylesheet" href="/website/assets/css/default.css" id="theme-stylesheet">
            ...
            <link rel="icon" type="image/png" sizes="192x192"  href="/website/assets/favicon/android-icon-192x192.png">
            ...
            <link rel="manifest" href="/website/assets/favicon/manifest.json">
